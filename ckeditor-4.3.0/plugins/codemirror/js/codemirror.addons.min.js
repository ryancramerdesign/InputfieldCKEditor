...
CodeMirror.Pos(a.line,a.ch+1))!=c||f.somethingSelected())return CodeMirror.Pass;f.execCommand("goCharRight")}f!=c&&(g=g+c);a["'"+f+"'"]=function(a){if(f=="'"&&a.getTokenAt(a.getCursor()).type=="comment")return CodeMirror.Pass;if(a.somethingSelected()){var m=a.getSelection();a.replaceSelection(f+m+c)}else if(f!=c||d(a)==CodeMirror.Pass){var m=a.getCursor(),n=CodeMirror.Pos(m.line,m.ch+1),e=a.getLine(m.line),o=e.charAt(m.ch),h=m.ch>0?e.charAt(m.ch-1):"";if(!(f==c&&CodeMirror.isWordChar(h))&&(e.length==
m.ch||g.indexOf(o)>=0||b.test(o)))a.replaceSelection(f+c,{head:n,anchor:n});else return CodeMirror.Pass}};f!=c&&(a["'"+c+"'"]=d)})(c.charAt(f),c.charAt(f+1));return a}function d(c){return function(a){var b=a.getCursor(),f=h(a,b);if(!f||0!=c.indexOf(f)%2)return CodeMirror.Pass;a.operation(function(){var f=CodeMirror.Pos(b.line+1,0);a.replaceSelection("\n\n",{anchor:f,head:f},"+input");a.indentLine(b.line+1,null,!0);a.indentLine(b.line+2,null,!0)})}}var b=/\s/;CodeMirror.defineOption("autoCloseBrackets",
!1,function(c,a,b){var f,j,l;(b!=CodeMirror.Init&&b&&c.removeKeyMap("autoCloseBrackets"),a)&&(f="()[]{}''\"\"",j="[]{}",typeof a=="string"?f=a:typeof a=="object"&&(a.pairs!=null&&(f=a.pairs),a.explode!=null&&(j=a.explode)),l=e(f),j&&(l.Enter=d(j)),c.addKeyMap(l))})})();
(function(){function h(b,c){if(b.indexOf)return b.indexOf(c);for(var a=0,d=b.length;a<d;++a)if(b[a]==c)return a;return-1}CodeMirror.defineOption("autoCloseTags",!1,function(b,c,a){if(c&&(a==CodeMirror.Init||!a)){a={name:"autoCloseTags"};(typeof c!="object"||c.whenClosing)&&(a["'/'"]=function(a){var f;var b=a.getCursor(),c=a.getTokenAt(b),d=CodeMirror.innerMode(a.getMode(),c.state),k=d.state;if(c.string.charAt(0)!="<"||c.start!=b.ch-1||d.mode.name!="xml")f=CodeMirror.Pass;else(b=k.context&&k.context.tagName)&&
a.replaceSelection("/"+b+">","end");return f});(typeof c!="object"||c.whenOpening)&&(a["'>'"]=function(a){var f;var b=a.getCursor(),c=a.getTokenAt(b),i=CodeMirror.innerMode(a.getMode(),c.state),k=i.state,m;if(i.mode.name!="xml"||!k.tagName)f=CodeMirror.Pass;else{var n=a.getOption("autoCloseTags"),p=i.mode.configuration=="html",i=typeof n=="object"&&n.dontCloseTags||p&&e,p=typeof n=="object"&&n.indentTags||p&&d,n=k.tagName;if(c.end>b.ch&&(n=n.slice(0,n.length-c.end+b.ch)),m=n.toLowerCase(),c.type==
"tag"&&k.type=="closeTag"||c.string.indexOf("/")==c.string.length-1||i&&h(i,m)>-1)f=CodeMirror.Pass;else{k=(c=p&&h(p,m)>-1)?CodeMirror.Pos(b.line+1,0):CodeMirror.Pos(b.line,b.ch+1);a.replaceSelection(">"+(c?"\n\n":"")+"</"+n+">",{head:k,anchor:k});c&&(a.indentLine(b.line+1),a.indentLine(b.line+2))}}return f});b.addKeyMap(a)}else!c&&a!=CodeMirror.Init&&a&&b.removeKeyMap("autoCloseTags")});var e="area base br col command embed hr img input keygen link meta param source track wbr".split(" "),d="applet blockquote body button div dl fieldset form frameset h1 h2 h3 h4 h5 h6 head html iframe layer legend object ol p select table ul".split(" ")})();
(function(){function h(b){var c=b.getCursor(),a=b.getTokenAt(c),d=CodeMirror.innerMode(b.getMode(),a.state).mode,f,j,l,i;if("comment"==a.type&&d.blockCommentStart&&(j=a.string.indexOf(d.blockCommentEnd),l=b.getRange(CodeMirror.Pos(c.line,0),CodeMirror.Pos(c.line,a.end)),-1==j||j!=a.string.length-d.blockCommentEnd.length))if(0==a.string.indexOf(d.blockCommentStart)){if(f=l.slice(0,a.start),!/^\s*$/.test(f)){f="";for(c=0;c<a.start;++c)f+=" "}}else-1!=(i=l.indexOf(d.blockCommentContinue))&&i+d.blockCommentContinue.length>
a.start&&/^\s*$/.test(l.slice(0,i))&&(f=l.slice(0,i));if(null!=f)b.replaceSelection("\n"+f+d.blockCommentContinue,"end");else return CodeMirror.Pass}for(var e=["clike","css","javascript"],d=0;d<e.length;++d)CodeMirror.extendMode(e[d],{blockCommentStart:"/*",blockCommentEnd:"*/",blockCommentContinue:" * "});CodeMirror.defineOption("continueComments",null,function(b,c,a){a&&a!=CodeMirror.Init&&b.removeKeyMap("continueComment");a={name:"continueComment"};a["string"==typeof c?c:"Enter"]=h;b.addKeyMap(a)})})();
(function(){function h(f,b,d){function g(b,d,k){var e,j,i,l;if(b.text){if(e=o?0:b.text.length-1,j=o?b.text.length:-1,b.text.length>m)return null;for(null!=k&&(e=k+h);e!=j;e+=h)if(i=b.text.charAt(e),u.test(i)&&f.getTokenTypeAt(c(d,e+1))==r)if(l=a[i],">"==l.charAt(1)==o)t.push(i);else{if(t.pop()!=l.charAt(0))return{pos:e,match:!1};if(!t.length)return{pos:e,match:!0}}}}var k=f.state.matchBrackets,m=k&&k.maxScanLineLength||1E4,b=b||f.getCursor(),k=f.getLineHandle(b.line),e=b.ch-1,p=0<=e&&a[k.text.charAt(e)]||
a[k.text.charAt(++e)],o,h,q;if(!p||(o=">"==p.charAt(1),h=o?1:-1,d&&o!=(e==b.ch)))return null;for(var r=f.getTokenTypeAt(c(b.line,e+1)),t=[k.text.charAt(e)],u=/[(){}[\]]/,d=b.line,p=o?Math.min(d+100,f.lineCount()):Math.max(-1,d-100);d!=p&&!(q=d==b.line?g(k,d,e):g(f.getLineHandle(d),d),q);d+=h);return{from:c(b.line,e),to:q&&c(d,q.pos),match:q&&q.match,forward:o}}function e(a,d){var e=a.state.matchBrackets.maxHighlightLineLength||1E3,g=h(a);if(g&&!(a.getLine(g.from.line).length>e)&&(!g.to||!(a.getLine(g.to.line).length>
e))){var e=g.match?"CodeMirror-matchingbracket":"CodeMirror-nonmatchingbracket",k=a.markText(g.from,c(g.from.line,g.from.ch+1),{className:e}),m=g.to&&a.markText(g.to,c(g.to.line,g.to.ch+1),{className:e});if(b&&a.state.focused&&a.display.input.focus(),g=function(){a.operation(function(){k.clear();m&&m.clear()})},d)setTimeout(g,800);else return g}}function d(a){a.operation(function(){g&&(g(),g=null);a.somethingSelected()||(g=e(a,!1))})}var b=/MSIE \d/.test(navigator.userAgent)&&(null==document.documentMode||
8>document.documentMode),c=CodeMirror.Pos,a={"(":")>",")":"(<","[":"]>","]":"[<","{":"}>","}":"{<"},g=null;CodeMirror.defineOption("matchBrackets",!1,function(a,b,c){if(c&&c!=CodeMirror.Init&&a.off("cursorActivity",d),b){a.state.matchBrackets=typeof b=="object"?b:{};a.on("cursorActivity",d)}});CodeMirror.defineExtension("matchBrackets",function(){e(this,!0)});CodeMirror.defineExtension("findMatchingBracket",function(a,b){return h(this,a,b)})})();
...
(function(){function h(d,b,c,a){function g(c){var e=f(d,b),g,i;if(!e||e.to.line-e.from.line<j)return null;g=d.findMarksAt(e.from);for(i=0;i<g.length;++i)if(g[i].__isFold&&"fold"!==a){if(!c)return null;e.cleared=!0;g[i].clear()}return e}var f=c&&(c.call?c:c.rangeFinder),j,l,i;if(f||(f=d.getHelper(b,"fold")),f){if("number"==typeof b&&(b=CodeMirror.Pos(b,0)),j=c&&c.minFoldSize||0,l=g(!0),c&&c.scanUp)for(;!l&&b.line>d.firstLine();)b=CodeMirror.Pos(b.line-1,0),l=g(!1);l&&(!l.cleared&&"unfold"!==a)&&(c=
e(c),CodeMirror.on(c,"mousedown",function(){i.clear()}),i=d.markText(l.from,l.to,{replacedWith:c,clearOnEnter:!0,__isFold:!0}),i.on("clear",function(a,b){CodeMirror.signal(d,"unfold",d,a,b)}),CodeMirror.signal(d,"fold",d,l.from,l.to))}}function e(d){var d=d&&d.widget||"↔",b;return"string"==typeof d&&(b=document.createTextNode(d),d=document.createElement("span"),d.appendChild(b),d.className="CodeMirror-foldmarker"),d}CodeMirror.newFoldFunction=function(d,b){return function(c,a){h(c,a,{rangeFinder:d,
...
CodeMirror.registerHelper("fold","brace",function(h,e){function d(d){for(var f,k=e.ch,g=0;;)if(f=0>=k?-1:c.lastIndexOf(d,k-1),-1==f){if(1==g)break;g=1;k=c.length}else{if(1==g&&f<e.ch)break;if(a=h.getTokenTypeAt(CodeMirror.Pos(b,f+1)),!/^(comment|string)/.test(a))return f+1;k=f-1}}var b=e.line,c=h.getLine(b),a,g="{",f="}",j=d("{"),l,i,k,m,n,p,o,s,q;if(null==j&&(g="[",f="]",j=d("[")),null!=j){l=1;i=h.lastLine();n=b;a:for(;n<=i;++n){p=h.getLine(n);for(o=n==b?j:0;!(s=p.indexOf(g,o),q=p.indexOf(f,o),0>
s&&(s=p.length),0>q&&(q=p.length),o=Math.min(s,q),o==p.length);){if(h.getTokenTypeAt(CodeMirror.Pos(n,o+1))==a)if(o==s)++l;else if(!--l){k=n;m=o;break a}++o}}if(null!=k&&(b!=k||m!=j))return{from:CodeMirror.Pos(b,j),to:CodeMirror.Pos(k,m)}}});CodeMirror.braceRangeFinder=CodeMirror.fold.brace;
...
b){for(var d=[],f;;){var e=g(a),i,j=a.line,h=a.ch-(e?e[0].length:0);if(!e||!(i=c(a)))break;if("selfClose"!=i)if(e[1]){for(f=d.length-1;0<=f;--f)if(d[f]==e[2]){d.length=f;break}if(0>f&&(!b||b==e[2]))return{tag:e[2],from:l(j,h),to:l(a.line,a.ch)}}else d.push(e[2])}}function j(c,d){for(var f=[],g,i;;){var j;a:{j=c;for(var h=void 0,r=i=void 0;;){if(h=j.ch?j.text.lastIndexOf(">",j.ch-1):-1,-1==h)if(b(j))continue;else{j=void 0;break a}if(e(j,h+1)){j=(i=j.text.lastIndexOf("/",h),r=-1<i&&!/\S/.test(j.text.slice(i+
1,h)),j.ch=h+1,r?"selfClose":"regular");break a}else j.ch=h}j=void 0}if(g=j,!g)break;if("selfClose"==g)a(c);else{r=c.line;j=c.ch;h=a(c);if(!h)break;if(h[1])f.push(h[2]);else{for(i=f.length-1;0<=i;--i)if(f[i]==h[2]){f.length=i;break}if(0>i&&(!d||d==h[2]))return{tag:h[2],from:l(c.line,c.ch),to:l(r,j)}}}}}var l=CodeMirror.Pos,i=RegExp("<(/?)([A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD-:.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*)",
"g");CodeMirror.registerHelper("fold","xml",function(a,b){for(var d=new h(a,b.line,0),e,i,j;!(e=g(d),!e||d.line!=b.line||!(i=c(d)));)if(!e[1]&&"selfClose"!=i)return b=l(d.line,d.ch),j=f(d,e[2]),j&&{from:b,to:j.from}});CodeMirror.tagRangeFinder=CodeMirror.fold.xml;CodeMirror.findMatchingTag=function(b,d,e){var g=new h(b,d.line,d.ch,e),i;if(-1!=g.text.indexOf(">")||-1!=g.text.indexOf("<")){var s=c(g),q=s&&l(g.line,g.ch),r=s&&a(g);if(s&&"selfClose"!=s&&r&&!(0<(g.line-d.line||g.ch-d.ch)))return i={from:l(g.line,
g.ch),to:q,tag:r[2]},r[1]?{open:j(g,r[2]),close:i,at:"close"}:(g=new h(b,q.line,q.ch,e),{open:i,close:f(g,r[2]),at:"open"})}};CodeMirror.findEnclosingTag=function(a,b,c){for(var d=new h(a,b.line,b.ch,c),e,g,i;!(e=j(d),!e);)if(g=new h(a,b.line,b.ch,c),i=f(g,e.tag),i)return{open:e,close:i}}})();
(function(){CodeMirror.defineExtension("autoFormatAll",function(h,e){for(var d=this,b=d.getMode(),c=d.getRange(h,e).split("\n"),a=CodeMirror.copyState(b,d.getTokenAt(h).state),g=d.getOption("tabSize"),f="",j=0,l=0==h.ch,i,k=0;k<c.length;++k){for(i=new CodeMirror.StringStream(c[k],g);!i.eol();){var m=CodeMirror.innerMode(b,a),n=b.token(i,a),p=i.current();i.start=i.pos;(!l||/\S/.test(p))&&(f+=p,l=!1);if(!l&&m.mode.newlineAfterToken&&m.mode.newlineAfterToken(n,p,i.string.slice(i.pos)||c[k+1]||"",m.state))f+=
"\n",l=!0,++j}!i.pos&&b.blankLine&&b.blankLine(a);!l&&k<c.length-1&&(f+="\n",l=!0,++j)}d.operation(function(){d.replaceRange(f,h,e);for(var a=h.line+1,b=h.line+j;a<=b;++a)d.indentLine(a,"smart");d.setCursor({line:0,ch:0})})})})();
...
b),f=g.indexOf(a.commentStart),j=g.lastIndexOf(a.commentEnd);-1<f&&-1<j&&j>f&&(g=g.substr(0,f)+g.substring(f+a.commentStart.length,j)+g.substr(j+a.commentEnd.length));c.replaceRange(g,d,b)}})});CodeMirror.defineExtension("autoIndentRange",function(e,d){var b=this;this.operation(function(){for(var c=e.line;c<=d.line;c++)b.indentLine(c,"smart")})});CodeMirror.defineExtension("autoFormatRange",function(e,d){for(var b=this,c=b.getMode(),a=b.getRange(e,d).split("\n"),g=CodeMirror.copyState(c,b.getTokenAt(e).state),
f=b.getOption("tabSize"),j="",h=0,i=0==e.ch,k,m=0;m<a.length;++m){for(k=new CodeMirror.StringStream(a[m],f);!k.eol();){var n=CodeMirror.innerMode(c,g),p=c.token(k,g),o=k.current();k.start=k.pos;(!i||/\S/.test(o))&&(j+=o,i=!1);if(!i&&n.mode.newlineAfterToken&&n.mode.newlineAfterToken(p,o,k.string.slice(k.pos)||a[m+1]||"",n.state))j+="\n",i=!0,++h}!k.pos&&c.blankLine&&c.blankLine(g);!i&&m<a.length-1&&(j+="\n",i=!0,++h)}b.operation(function(){b.replaceRange(j,e,d);for(var a=e.line+1,c=e.line+h;a<=c;++a)b.indentLine(a,
